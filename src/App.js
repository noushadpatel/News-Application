...
export default class App extends Component {
  ...
  render() {
    return (
      ...
      />
        <Routes>
          <Route exact path='/home' element={<News setProgress={this.setProgress} key="gen" pageSize={this.pageSize} country="in" category="general"/>} />
          <Route exact path='/' element={<News setProgress={this.setProgress} key="gen1" pageSize={this.pageSize} country="in" category="general"/>} />
